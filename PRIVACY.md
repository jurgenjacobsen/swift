...
This Privacy Policy describes how your data is handled by the **Swift** Chrome Extension (the "Extension"). 

## 1. Our Privacy Philosophy
We believe that productivity tools should respect user privacy. **Swift is designed to be a private, local-first tool.** ## 2. Data Collection
**Swift does not collect, store, or transmit any personal data.**
